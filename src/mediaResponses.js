...
// Retrieves an image to give to the client. Takes in an imageName only, since we know where all images are stored.
...
const getSongPreview = (response, songName, artistName) => {
    ...
    https.get(searchURL, (res) => {
        ...
        res.on('end', () => {
            ...
            const song = data.results.find(track =>
                track.trackName.toLowerCase() === songName.toLowerCase() &&
